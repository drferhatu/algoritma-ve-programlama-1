---
week: 8
title: "Lab 8 · Metotlara Bölmek ve KT2 Teslimi"
description: "Uzun bir programı metotlara bölme, parametreli ve değer döndüren metotlar; portfolyonun döngülü sürümünün (KT2) teslimi."
status: taslak
objectives:
  - "Tekrar eden kodu metoda çıkararak verilen programı kısaltır."
  - "En az üç değer döndüren metot yazar ve main'den çağırır."
  - "KT2: gözcü değerle biten menü döngüsü ve girdi doğrulama içeren sürümü push eder."
tools:
  - "JDK 21"
  - "VS Code"
  - "GitHub Codespaces"
...
`lab08/` klasörünü portfolyo deponuza push edin ve asistana **30 saniyede** bir görevi anlatın. Yapay zeka **sarı bölge**: soru sorabilirsiniz, kod kopyalayamazsınız.
